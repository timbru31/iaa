...
<s:form action="saveExam">
  ...
  <div class="form-group">
    ...
    <s:textfield name="exam.creditPoints" id="create.examCP"
      type="number" step="0.5" required="true" class="form-control"
      placeholder="%{getText('create.examCP')}" />
  </div>
  <div class="form-group">
    <label for="create.examPeriod"><s:text
        name="create.examPeriod" /></label>
    <s:textfield name="exam.startDate" id="create.examPeriod"
      required="true" class="form-control"
      pattern="^(31|30|0[1-9]|[12][0-9]|[1-9])\.(0[1-9]|1[012]|[1-9])\.((18|19|20)\d{2}|\d{2})$"
      placeholder="%{getText('create.startDate')}" />
    <s:textfield name="exam.finalSubmitDate" id="create.examPeriod"
      required="true" class="form-control"
      pattern="^(31|30|0[1-9]|[12][0-9]|[1-9])\.(0[1-9]|1[012]|[1-9])\.((18|19|20)\d{2}|\d{2})$"
