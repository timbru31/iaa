...
<s:form action="createExam">
  <table class="table">
    <tr>
      ...
      <td><s:textfield name="exam.name" class="form-control"
          placeholder="%{getText('create.enterExamName')}" /></td>
    <tr>
      <td><b><s:text name="create.examTime" /></b></td>
      <td><s:textfield name="exam.examTime" class="form-control"
          placeholder="%{getText('create.enterExamTime')}" /></td>
    <tr>
      <td><b><s:text name="create.minPoints" /></b></td>
      <td><s:textfield name="exam.minPoints" class="form-control"
          placeholder="%{getText('create.enterMinPoints')}" /></td>
    <tr>
      <td><b><s:text name="create.examCP" /></b></td>
      <td><s:textfield name="exam.creditPoints"
          class="form-control"
          placeholder="%{getText('create.enterExamCP')}" /></td>
    <tr>
      <td><b><s:text name="create.examPeriod" /></b></td>
      <td><s:textfield name="exam.examPeriod" class="form-control"
          placeholder="%{getText('create.enterExamPeriod')}" /></td>
  </table>
  <br />
  ...
  <form>
    <div class="row" style="border: 1px solid black">
      ...
      <s:textfield id="Simple Choice" class="form-control"
        placeholder="%{getText('create.enterQuestion')}" />
      <br />
      <div>
        <input type="Radio" name="answer" /> <input type="text">
      </div>
      <br /> <input type="Radio" name="answer" /> <input type="text">
      <br />
  ...
  <form>
    <div class="row" style="border: 1px solid black">
      ...
      <br /> <input type="checkbox" name="answer" /> <input
        type="text"> <br />
      <button type="button" class="btn btn-default navbar-btn">
        <s:text name="create.nextAnswer" />
      </button>
